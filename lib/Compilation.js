		...
		module.needBuild(
			...
			(err, needBuild) => {
				...
				if (!needBuild) {
					...
					// Invalidate cached source types since incoming
					// connections may have changed since the last build
					// (e.g. asset module now referenced from JS via lazy compilation)
					// https://github.com/webpack/webpack/issues/20800
					module.invalidateReuse();
