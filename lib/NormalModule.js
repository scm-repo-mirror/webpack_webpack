...
>>>>>>> 846a6fbaa (fix: make asset modules available in JS when referenced from CSS and lazy JS)
	...
	updateHash(hash, context) {
		...
		// Include source types in hash so that when incoming connections change
		// the hash changes and code generation cache is invalidated.
		// Without this, an asset module initially only referenced from CSS would
		// not regenerate JS code when later referenced from a lazy JS chunk.
